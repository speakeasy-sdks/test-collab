...
// ProveAuthInternalGo - Prove Auth API: This specification describes the Prove Auth API.
//
// Swagger 2.0 Spec - generated by [go-swagger](https://github.com/go-swagger/go-swagger)
type ProveAuthInternalGo struct {
	Auth   *Auth
	Device *Device
	Push   *Push
...
type SDKOption func(*ProveAuthInternalGo)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *ProveAuthInternalGo) {
...
func New(opts ...SDKOption) *ProveAuthInternalGo {
	sdk := &ProveAuthInternalGo{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			OpenAPIDocVersion: "1.37.3",
			SDKVersion:        "0.0.1",
			GenVersion:        "2.248.6",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.248.6 1.37.3 github.com/speakeasy-sdks/test-collab",
		},
	}
